...
add_action( 'customize_register', 'the_territory_remove_default_customizer_sections', 15 );
 ...
 */
function the_territory_include_custom_controls() {
...
add_action( 'customize_register', 'the_territory_include_custom_controls', -999 );
 ...
 * @author WebDevStudios
 */
function the_territory_customize_scripts() {
...
add_action( 'customize_preview_init', 'the_territory_customize_scripts' );
 ...
 */
function the_territory_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = [
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'the_territory_copyright_text' => '.site-info',
	];
...
add_action( 'customize_register', 'the_territory_selective_refresh_support' );
 ...
 */
function the_territory_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'the_territory_live_preview_support', 999 );
