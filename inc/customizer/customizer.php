 ...
 */
function our_forests_remove_default_customizer_sections( $wp_customize ) {
...
add_action( 'customize_register', 'our_forests_remove_default_customizer_sections', 15 );
 ...
 */
function our_forests_include_custom_controls() {
...
add_action( 'customize_register', 'our_forests_include_custom_controls', -999 );
 ...
 * @author WebDevStudios
 */
function our_forests_customize_scripts() {
	wp_enqueue_script( 'the-territory-customize-livepreview', get_template_directory_uri() . '/inc/customizer/assets/scripts/livepreview.js', [ 'jquery', 'customize-preview' ], '1.0.0', true );
}
add_action( 'customize_preview_init', 'our_forests_customize_scripts' );
 ...
 */
function our_forests_selective_refresh_support( $wp_customize ) {

	// The <div> classname to append edit icon too.
	$settings = [
		'blogname'          => '.site-title a',
		'blogdescription'   => '.site-description',
		'our_forests_copyright_text' => '.site-info',
	];
...
add_action( 'customize_register', 'our_forests_selective_refresh_support' );
 ...
 */
function our_forests_live_preview_support( $wp_customize ) {
...
add_action( 'customize_register', 'our_forests_live_preview_support', 999 );
