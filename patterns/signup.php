...
<div class="wp-block-group signup">
    ...
    <!-- wp:paragraph -->
    <p><?php esc_html_e( 'Sign up to receive updates about upcoming screenings of The Territory,<br>as well as our impact efforts around the world.', 'the-territory' ); ?></p>
    <!-- /wp:paragraph -->
