<?php
  ...
  * Slug: the-territory/section-demand-change
...
<section class="wp-block-group section demand-change">
  <!-- wp:heading -->
  <h2 id="demand-change"><?php esc_html_e( 'Demand Change', 'our-forests' ); ?></h2>
  <!-- /wp:heading -->
  ...
  <!-- wp:paragraph -->
  <p><?php esc_html_e( 'Forests in the Amazon and elsewhere are being destroyed at an alarming rate to farm cattle and produce palm oil and soy for international consumption. Some individual company commitments to deforestation-free supply chains have been made, but these are not enough.', 'our-forests' ); ?></p>
  <!-- /wp:paragraph -->

  <!-- wp:paragraph -->
  <p><?php esc_html_e( 'After COP26 in 2021, governments committed to funding Indigenous communities. We are calling on a portion of this funding to be provided to empower Indigenous communities to conduct surveillance and monitoring on their land - just as the Uru-eu-wau-wau are doing - so that they can identify on the ground when illegal logging takes place, and help companies comply with their obligations of due diligence and eliminate deforestation from their global supply chains.', 'our-forests' ); ?></p>
  <!-- /wp:paragraph -->
</section>
<!-- /wp:group -->