...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'globals', 'the-territory' ); ?>"><?php esc_html_e( 'Globals', 'the-territory' ); ?></h2>

	<?php
		// Theme colors.
		the_territory_display_global_scaffolding_section(
			[
				'global_type' => 'colors',
				'title'       => 'Colors',
				'arguments'   => [
