...
<section class="section-scaffolding">
	...
	<h2 class="scaffolding-heading" id="<?php esc_html_e( 'icons', 'the-territory' ); ?>"><?php esc_html_e( 'Icons', 'the-territory' ); ?></h2>
	...
	the_territory_display_scaffolding_section(
		[
			...
			'usage'       => '<?php the_territory_display_svg( array(
